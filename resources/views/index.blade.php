...
<div class="container">
    <div class="producten_show">
        ...
        <div class="row justify-content-center">
            <h4>Producten</h4>
            <div class="filter_main w-100">
                {!! Form::open(['action' => ['App\Http\Controllers\CRUDController@index'], 'method' => 'POST','class' => 'pull-right float-left']) !!}
                    {{ Form::text('naam',$filter[0]['zoek'],['maxlength'=>'20']) }}
