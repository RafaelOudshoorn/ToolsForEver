    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            @else
                ...
                @else 
                <div class="w-100 mb-5" style="display:grid;grid-template-columns: 70% 30%">
                    <div id="card-body" class="p-2">
                        @foreach ($winkelwagen as $item)
                        <div class="card mb-2">
                            <div class="card-body" style="height:200px;display: grid;grid-template-columns: 25% auto 15%">
